; Claude Sentinel NSIS installer hooks (tauri.conf.json
; bundle.windows.nsis.installerHooks).
;
; The daemon sidecar (claude-sentinel-daemon.exe) is deliberately
...
;   "Error opening file for writing: ...\claude-sentinel-daemon.exe"
...
!macro NSIS_HOOK_PREINSTALL
  ...
  nsExec::Exec 'taskkill /F /IM claude-sentinel-daemon.exe'
  Pop $0
