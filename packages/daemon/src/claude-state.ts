 ...
 */
export function readClaudeState(filePath: string = CLAUDE_JSON_PATH): ClaudeState {
...
export function updateClaudeState(
  ...
  filePath: string = CLAUDE_JSON_PATH,
): void {
 ...
 * @param filePath - path to the claude.json file (defaults to ~/.claude.json)
 */
export function writeClaudeState(state: ClaudeState, filePath: string = CLAUDE_JSON_PATH): void {
 ...
 * @param filePath - path to the claude.json file (defaults to ~/.claude.json)
 */
export function setActiveAccount(account: OAuthAccount, filePath: string = CLAUDE_JSON_PATH): void {
 ...
 * @param filePath - path to the claude.json file (defaults to ~/.claude.json)
 */
export function getActiveAccount(filePath: string = CLAUDE_JSON_PATH): OAuthAccount | null {
