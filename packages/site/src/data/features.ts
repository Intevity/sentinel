...
export const features: Feature[] = [
  ...
  },
  {
    slug: 'metrics',
    label: 'Metrics',
    title: 'The cost history Claude Code forgets',
    tagline: 'Cost and token metrics straight from an OTEL receiver.',
    description:
      "Sentinel collects OpenTelemetry metrics straight from Claude Code and breaks down cost, token counts, and cache hit rate over time. Claude Code's own /cost shows only the running total for your current session and forgets it the moment you quit, so Sentinel keeps the full history across every session and account.",
    icon: 'chart',
    video: 'metrics.mp4',
    poster: 'metrics.jpg',
    hasVideo: true,
